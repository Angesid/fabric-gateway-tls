...
export const GLOBAL = {
  ...
  // TLS / HTTPS settings (dev-friendly defaults)
  // Set TLS_ENABLED=true in your .env to enable HTTPS mode
  tlsEnabled: Env.getString("TLS_ENABLED", "false") === "true",
  tlsKeyPath: Env.getString("TLS_KEY_PATH", "/etc/ssl/fabric-gateway/privkey.pem"),
  tlsCertPath: Env.getString("TLS_CERT_PATH", "/etc/ssl/fabric-gateway/fullchain.pem")
};
